...
\begin{tikzpicture}
  ...
  %\node[draw,circle,minimum width=1cm] (rho) at (-1,3) {$\rho$};
    ...
    \draw[-] (0,3.25)--(0.5,3.25)--(0.5,3.4);
    \draw[-latex] (0.5,3.6)--(0.5,4);
  ...
  \node[draw,rectangle,minimum width=3cm,minimum height=4.8cm,text width=2.5cm, align=center] (tbc) at (3.5,-6.5) {\Large Secret Key Correction};
  ...
  \draw[-latex] (5,-4.5)--(5.5,-4.5)--(5.5,-9.0)--(-2.4,-9.0)--(-2.4, 1.65)--(0,1.65)--(0,1.25);
  ...
  \node[draw,rectangle,minimum width=3cm,minimum height=4.8cm,text width=2.5cm, align=center] (tbc) at (3.5,-6.5) {\Large Tweak Correction};
  ...
  \begin{scope}[xshift=27cm]
    ...
    \draw[latex-,dashed] (5,-4.25)--(6,-4.25)--(6,4);
  ...
  \node[draw,rectangle,minimum width=3cm,minimum height=4.8cm,text width=2.5cm, align=center] (tbc) at (3.5,-6.5) {\huge Counter};
  ...
  \draw[-latex] (0,-8.5)--(0,-8.75)--(2,-8.75);
  \draw[-latex] (1.8,-8.75)--(1.8,-3.4)--(2,-3.4);
  \end{scope}
\end{tikzpicture}
